 ...
 * @LastEditTime: 2022-12-07 12:53:59
 * @Copyright: [版权] 2022  Creator CO.LTD. All Rights Reserved.
 * @Descripttion: 
 */
module.exports = {
    'name': 'cc-obfuscated-3_x obfuscated',
    'description': "The code obfuscation tool supports automatic code obfuscation after project construction,<br>supports code obfuscation of WeChat games and bytedance-mini-game, and supports code obfuscation of subcontracting.<br>The obfuscation parameters can be adjusted in the project settings panel, and the obfuscation parameters can be set in the construction panel.<br>At present, the display layer of each panel surface is not synchronized, and the saved obfuscation JSON file is synchronized",
    'menu': {
        name: "Code Obfuscated ·✍",
        argu_web_set: "parameter · WEB",
        argu_set: "parameter · set",
        argu_des: "parameter · select",
        change_uuid: "change all UUID",
